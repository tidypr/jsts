  ...
  return (
    <div className='max-w-100vh flex h-32 w-32 items-center justify-center'>
      ...
      <div className='pointer-events-none absolute inset-0 flex items-center justify-center'>
        <div className='animate-ping-slow absolute h-32 w-32 rounded-full border-2 border-primary/20' />
        <div className='animate-ping-slower absolute h-80 w-80 rounded-full border-2 border-primary/10' />
        <div className='animate-ping-slowest absolute h-96 w-96 rounded-full border-2 border-primary/5' />
      </div>
      ...
      <div className='z-10 max-w-md space-y-8 text-center'>
        ...
        <div className='max-w-1/3 h-32 w-32'>
          <div className='animate-scale-in absolute inset-0 rounded-full bg-primary/10' />
          <div className='animate-scale-in-delay-1 absolute inset-2 rounded-full bg-primary/20' />
          <div className='animate-scale-in-delay-2 absolute inset-4 flex items-center justify-center rounded-full bg-primary'>
            <svg
